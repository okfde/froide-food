...
class VenueRequest(models.Model):
    ...
    amenity = models.ForeignKey(
        Amenity, null=True, blank=True, on_delete=models.SET_NULL
    )
...
class VenueRequestItem(models.Model):
    venue = models.ForeignKey(
        VenueRequest, related_name="request_items", on_delete=models.CASCADE
    )
...
class FoodSafetyReport(models.Model):
    venue = models.ForeignKey(VenueRequest, null=True, on_delete=models.SET_NULL)
    request_item = models.ForeignKey(
        VenueRequestItem, null=True, on_delete=models.SET_NULL
    )
    ...
    attachment = models.ForeignKey(
        FoiAttachment, null=True, blank=True, on_delete=models.SET_NULL
    )
    amenity = models.ForeignKey(
        Amenity, null=True, blank=True, on_delete=models.SET_NULL
    )
